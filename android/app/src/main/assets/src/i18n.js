...
export const TRANSLATIONS = {
  en: {
    ...
    selectChurchPrompt: 'Select a church from the map or suggestions first.',
    churchSelected: 'Church selected.',
  ...
  'fr-CA': {
    ...
    selectChurchPrompt: 'Choisissez d’abord une église sur la carte ou dans les suggestions.',
    churchSelected: 'Église sélectionnée.',

...
export const TRANSLATIONS = {
  en: {
    ...
    isSomethingWrong: 'Is there something wrong?',
    findHost: 'Find a church near you',
    ...
    privacyPage: 'Privacy',
    privacyBody: 'This project stores venue, event, report, and moderation data in your browser for now. Do not enter sensitive personal information.',
    legalPage: 'Legal',
    ...
    clearFilters: 'Clear',
    hostsMatchingFilters: 'churches matching filters.',
    hostDetails: 'Church details',
    emptyState: 'Click a marker on the map to view details.',
    addUpdateHost: 'Add / update church',
    editMyHost: 'Edit my church',
    editingHost: 'Editing church',
    ...
    hostsFoundNearAddress: 'churches found near your address.',
    ...
    approve: 'Approve',
    deny: 'Deny',
    manageHosts: 'Manage churches',
    searchHosts: 'Search churches',
    delete: 'Delete',
    deleteChurchConfirm: 'Delete this church:',
    deleteHostConfirm: 'Delete this host:',
    ...
    noHostsFound: 'No churches found.',
    ...
    atLabel: 'at',
    reportTitle: 'Suggest a correction / missing data',
    yourName: 'Your name',
    ...
    message: 'Message',
    sendReport: 'Send suggestion',
    reportSubmitted: 'Suggestion submitted. Thank you!',
    ...
    myHostEyebrow: 'Private workspace',
    myHostTitle: 'My church',
    placesMode: 'Churches',
    eventsMode: 'Events',
    reportsTab: 'Reports',
    ...
    addHost: 'Add church',
    addEvent: 'Add event',
    addHostFirst: 'Add or select a church first.',
    ...
    selectHostPrompt: 'Select a host from the map or reports first.',
    hostSelected: 'Host selected.',
    duplicateHostBlocked: 'Potential duplicate host blocked. Existing entry:',
  ...
  'fr-CA': {
    ...
    isSomethingWrong: 'Y a-t-il quelque chose qui ne va pas ?',
    findHost: 'Trouver une église près de vous',
    ...
    privacyBody: 'Ce projet stocke pour le moment les lieux, événements, rapports et données de modération dans votre navigateur. N’ajoutez pas d’informations sensibles.',
    ...
    hostsMatchingFilters: 'églises correspondent aux filtres.',
    hostDetails: "Détails de l'église",
    emptyState: 'Cliquez sur un marqueur pour voir les détails.',
    addUpdateHost: 'Ajouter / modifier une église',
    editMyHost: 'Modifier mon église',
    editingHost: 'Modification de l’église',
    editingEvent: 'Modification de l’événement',
    churchSaved: 'Église enregistrée.',
    hostSaved: 'Hôte enregistré.',
    eventSaved: 'Événement enregistré.',
    hostName: "Nom de l'église",
    ...
    hostsFoundNearAddress: 'églises trouvées près de votre adresse.',
    ...
    approve: 'Approuver',
    deny: 'Refuser',
    manageHosts: 'Gérer les églises',
    searchHosts: 'Rechercher églises',
    delete: 'Supprimer',
    deleteChurchConfirm: 'Supprimer cette église :',
    deleteHostConfirm: 'Supprimer cet hôte :',
    ...
    noHostsFound: 'Aucune église trouvée.',
    ...
    repeatsLabel: 'Répète :',
    atLabel: 'à',
    reportTitle: 'Suggérer une correction / donnée manquante',
    yourName: 'Votre nom',
    ...
    reportSubmitted: 'Rapport envoyé. Merci !',
    ...
    myHostEyebrow: 'Espace privé',
    myHostTitle: 'Mon église',
    placesMode: 'Églises',
    eventsMode: 'Événements',
    reportsTab: 'Rapports',
    hostRequestsTab: 'Demandes hôte',
    reviewReportsTitle: 'Réviser les rapports',
    reviewHostRequestsTitle: 'Réviser les demandes hôte',
    findHostEyebrow: 'Découvrir',
    mapView: 'Vue carte',
    ...
    addHost: 'Ajouter une église',
    addEvent: 'Ajouter un événement',
    addHostFirst: 'Ajoutez ou sélectionnez d’abord une église.',
    ...
    selectedTypes: 'Sélectionnés',
    selectHostPrompt: 'Choisissez d’abord un hôte sur la carte ou dans les rapports.',
    hostSelected: 'Hôte sélectionné.',
    duplicateHostBlocked: 'Hôte potentiellement en double bloqué. Entrée existante :',
    ...
    newHostName: 'Nouvelle église hôte',
...
export function applyLanguage(state, elements, onSelectedHostRender) {
  ...
  elements.adminTitle.textContent = state.selectedHostId ? t(state, 'editingHost') : t(state, state.isHostMode ? 'editMyHost' : 'addUpdateHost');

  if (state.selectedHostId) onSelectedHostRender();
}
